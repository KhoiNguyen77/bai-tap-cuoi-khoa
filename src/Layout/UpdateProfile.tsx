            ...
            >
                <form onSubmit={updateMik.handleSubmit}>
                    <div className="container mx-auto px-10 grid sm:grid-cols-2 gap-4 mt-9">
                     ...
                     " id="name" name='name' type="text" placeholder="Điền tên người dùng" defaultValue={userUpdate?.name} onChange={updateMik.handleChange} />
                            </div>
                            <div className='mb-3'>
                            ...
                            <div className='mb-3'>
                                ...
                                <input className="bg-gray-100 border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5
                     " id="phone" type="number" placeholder="Điền số điện thoại" defaultValue={userUpdate?.phone} onChange={updateMik.handleChange} />
                            </div>
                        ...
                        <div className="mb-6 w-full ml-2">
                            <div className="mb-3">
                                ...
                                <input className="bg-gray-100 border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5
                     " id="email" placeholder="Email" defaultValue={userUpdate?.email} onChange={updateMik.handleChange} />
                            </div>
                            <div className="mb-3">
                                <label
                                    htmlFor="birthday"
                                ...
                                <input
                                    type="date"
                                    id="birthday"
                                    defaultValue={userUpdate?.birthday} onChange={updateMik.handleChange}
