  ...
  return (
    <>
      <nav className="top-0  w-full z-20 border-b shadow-lg">
        <div className=" container mx-auto px-2 sm:px-10 py-5 flex flex-row justify-center  items-center w-full  md:justify-between">
          <NavLink
            to=""
          ...
          <div
            className="flex flex-wrap items-center justify-around relative z-20 cursor-pointer shrink-0  "
            onClick={() => {
