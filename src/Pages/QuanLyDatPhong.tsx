      ...
      <div className='flex'>
        <div className="flex flex-col mt-4 md:px-10 lg:w-2/3">
          <div className="border mb-4 rounded-lg hover:shadow-xl duration-200 flex cursor-pointer">
            <div><img src="https://airbnb.cybersoft.edu.vn/public/images/room/1658134435797_put-together-a-perfect-guest-room-1976987-hero-223e3e8f697e4b13b62ad4fe898d492d.jpg" alt="https://airbnb.cybersoft.edu.vn/public/images/room/1658134435797_put-together-a-perfect-guest-room-1976987-hero-223e3e8f697e4b13b62ad4fe898d492d.jpg" className="h-full rounded-l-lg" /></div><div className="px-4 py-2  w-full"><div className="flex justify-between items-center md:border-b pb-2"><div><h3 className="font-semibold md:text-xl uppercase">Khách Sạn Hồng Hào</h3><span className="text-gray-600 text-xs md:text-sm md:ml-2">
              <span>17-07-2023 -&gt; </span><span>17-07-2023</span></span></div>
              <div><span className="font-semibold text-sm md:text-xl">0
                <span className="font-medium text-gray-600 text-xs md:text-sm">$/0 ngày</span>
              </span></div></div><div className="hidden md:block"><h3 className="font-semibold text-sm md:text-lg text-gray-800">Tiện ích</h3>
                <div className="flex items-center"><div className="flex items-center p-3"><div><svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style={{ display: 'block', height: 24, width: 24, fill: 'currentcolor' }}><path d="M26 1a5 5 0 0 1 5 5c0 6.389-1.592 13.187-4 14.693V31h-2V20.694c-2.364-1.478-3.942-8.062-3.998-14.349L21 6l.005-.217A5 5 0 0 1 26 1zm-9 0v18.118c2.317.557 4 3.01 4 5.882 0 3.27-2.183 6-5 6s-5-2.73-5-6c0-2.872 1.683-5.326 4-5.882V1zM2 1h1c4.47 0 6.934 6.365 6.999 18.505L10 21H3.999L4 31H2zm14 20c-1.602 0-3 1.748-3 4s1.398 4 3 4 3-1.748 3-4-1.398-4-3-4zM4 3.239V19h3.995l-.017-.964-.027-.949C7.673 9.157 6.235 4.623 4.224 3.364l-.12-.07zm19.005 2.585L23 6l.002.31c.045 4.321 1.031 9.133 1.999 11.39V3.17a3.002 3.002 0 0 0-1.996 2.654zm3.996-2.653v14.526C27.99 15.387 29 10.4 29 6a3.001 3.001 0 0 0-2-2.829z" /></svg></div></div><div className="flex items-center p-3"><div><svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style={{ display: 'block', height: 24, width: 24, fill: 'currentcolor' }}>
        ...
        <div className="hidden md:block md:w-1/3">
          <div className="w-full sticky top-32 border mt-4 rounded-lg shadow-lg p-4">
            ...
            <a className="inline-block w-auto my-4 border border-black font-semibold hover:bg-gray-200 duration-200 px-5 py-3 rounded-lg" href="/">Bắt đầu tìm kiếm</a>
          </div>
        </div>
      </div>
    </div>
