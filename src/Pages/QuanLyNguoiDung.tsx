...
import { deleteUserById, getAllProfileApi, UserProfile } from '../Reducer/userReducer';
...
const QuanLyNguoiDung = (props: Props) => {
  ...
  const columns: ColumnsType<DataType> = [
...

    {
      ...
      render: (_, record) => {
        return <img
          src={record.avatar ? record.avatar : "https://a0.muscache.com/defaults/user_pic-50x50.png?v=3"}
          alt="Foto Perfil"
