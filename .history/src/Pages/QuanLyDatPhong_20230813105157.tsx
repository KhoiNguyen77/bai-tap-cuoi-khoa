...
const QuanLyDatPhong: React.FC = (props: Props) => {
  ...
  data.forEach(row => {
    const convertString = new Date(row.ngayDen);
    const getDate = convertString.getDate();
    row.ngayDen = `${convertString.getDate()}/${convertString.getMonth()-1}/${convertString.getFullYear()}`;
    row.ngayDi = `${convertString.getDate()}/${convertString.getMonth()-1}/${convertString.getFullYear()}`;
    console.log(row.ngayDen);
  })
