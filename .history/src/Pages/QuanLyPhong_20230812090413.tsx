...
const QuanLyPhong = (props: Props) => {
  ...
  const openModalById = (id: number, open: boolean) => {
        ...
        <div className="container mx-auto px-10 grid sm:grid-cols-2 gap-4 mt-9">
          ...
          <div className="mb-6 w-full ml-2">
            <div className="mb-3">
              ...
              <Radio.Group id="mayGiat" name="mayGiat" value={rooms[index]?.mayGiat}>
            ...
            <div className="mb-3">
              ...
              <Radio.Group id="banLa" name="banLa" value={rooms[index]?.banLa}>
                <Radio value={true} id="yes" className="mr-20">
                  Có
                </Radio>
                <Radio value={false} id="no">
            ...
            <div className="mb-3">
              ...
              <Radio.Group id="dieuHoa" name="dieuHoa" value={rooms[index]?.dieuHoa}>
                <Radio value={true} id="yes" className="mr-20">
                  Có
                </Radio>
                <Radio value={false} id="no">
            ...
            <div className="mb-3">
              ...
              <Radio.Group id="wifi" name="wifi" value={rooms[index]?.wifi}>
                <Radio value={true} id="yes" className="mr-20">
                  Có
                </Radio>
                <Radio value={false} id="no">
            ...
            <div className="mb-3">
              ...
              <Radio.Group id="bep" name="bep" value={rooms[index]?.bep}>
                <Radio value={true} id="yes" className="mr-20">
                  Có
                </Radio>
                <Radio value={false} id="no">
            ...
            <div className="mb-3">
              ...
              <Radio.Group id="doXe" name="doXe" value={rooms[index]?.doXe}>
                <Radio value={true} id="yes" className="mr-20">
                  Có
                </Radio>
                <Radio value={false} id="no">
            ...
            <div className="mb-3">
              ...
              <Radio.Group id="hoBoi" name="hoBoi" value={rooms[index]?.hoBoi}>
                <Radio value={true} id="yes" className="mr-20">
                  Có
                </Radio>
                <Radio value={false} id="no">
            ...
            <div className="mb-3">
              ...
              <Radio.Group id="banUi" name="banUi" value={rooms[index]?.banUi}>
                <Radio value={true} id="yes" className="mr-20">
                  Có
                </Radio>
                <Radio value={false} id="no">
