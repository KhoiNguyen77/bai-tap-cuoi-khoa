        ...
        <tbody>
          <tr className="hover:bg-grey-lighter">
            ...
            <td className="py-2 px-4 border-b border-grey-light text-center">
              <button className='p-3 bg-blue-300 mx-3 rounded-md hover:bg-blue-500'>Xem</button>
              <button className='p-3 bg-green-300 mx-3 rounded-md hover:bg-green-500'>Sửa</button>
              <button className='p-3 bg-red-300 mx-3 rounded-md hover:bg-red-500'>Xóa</button>
            </td>
          </tr>
