      ...
      <table className="w-full table-auto text-sm">
        ...
        <tbody>
          <tr className="hover:bg-grey-lighter">
            ...
            <td className="py-2 px-4 border-b border-grey-light">Comercio</td>
            <td className="py-2 px-4 border-b border-grey-light">
              <button className='p-3 bg-blue-300 mx-3 rounded-md'>Xem</button>
              <button className='p-3 bg-yellow-200-300 mx-3 rounded-md'>Sửa</button>
              <button className='p-3 bg-red-300 mx-3 rounded-md'>Xóa</button>
            </td>
          </tr>
