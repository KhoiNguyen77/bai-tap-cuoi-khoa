      ...
      <div className="container grid xs:grid-cols-1 lg:grid-cols-2 gap-10 justify-center">
        <div className="room-list">
          <div className="grid lg:grid-cols-2 sm:grid-cols-1 justify-center gap-10 w-full">
            <NavLink to={"/"} className="room cursor-pointer hover:shadow-2xl ease-in-out duration-200 p-5 rounded-lg">
            ...
            <NavLink to={"/"} className="room cursor-pointer hover:shadow-lg p-3 rounded-lg">
              <div className="room_image mb-4">
                <img
                  className="rounded-lg"
                  width={"100%"}
        ...
        <div className="map w-full xs:hidden md:block">
          <iframe
          className="rounded-lg"
