...
const UpdateProfile = (props: Props) => {
    ...
    return (
        <>
            <button className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 border border-red-700 rounded" onClick={() => setOpen(true)}>
                Thay đổi thông tin
            </button>
                    ...
                    <div className="container mx-auto px-10 grid sm:grid-cols-2 gap-4 mt-9">
                        ...
                        <div className="mb-4 w-full">
                            <div className='mb-3'>
                                ...
                                <input className="bg-gray-100 border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5
                     " id="name" name='name' type="text" placeholder="Điền tên người dùng" defaultValue={profile?.name} onChange={updateMik.handleChange} />
                            ...
                            <div className='mb-3'>
                                ...
                                <Radio.Group id='gender' name='gender' defaultValue={profile?.gender} onChange={updateMik.handleChange} >
                            ...
                            <div className='mb-3'>
                                ...
                                <input className="bg-gray-100 border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5
                     " id="phone" type="number" placeholder="Điền số điện thoại" defaultValue={profile?.phone} onChange={updateMik.handleChange} />
                        ...
                        <div className="mb-6 w-full ml-2">
                            <div className="mb-3">
                                ...
                                <input className="bg-gray-100 border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5
                     " id="email" placeholder="Email" defaultValue={profile?.email} onChange={updateMik.handleChange} />
                            ...
                            <div className="mb-3">
                                ...
                                <input
                                    type="date"
                                    id="birthday"
                                    defaultValue={profile?.birthday} onChange={updateMik.handleChange}
                        ...
                        <button type='submit' className="bg-red-500 items-end  hover:bg-red-700 text-white font-bold py-2 px-4 border border-red-700 rounded" >
                            Sửa thông tin
                        </button>
                    </div>
